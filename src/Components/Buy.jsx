  ...
  return (
    <div className='p-20 bg-[#000302] relative'>
      ...
      <div className="cards flex flex-col justify-between items-center">
        ...
        <div className=" p-3 rounded-2xl flex bg-[#1d2521] mt-20">
          <p className='border-r-[1px] border-[#ABABAB] p-3 text-[#00FF85] inter text-lg'>Contract Address</p>
          <p
            className='address p-3 text-white text-lg inter cursor-pointer'
